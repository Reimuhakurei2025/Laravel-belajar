<x-layout>
    ...
    <article class="pt-3 text-justify">
    <h1 class="text-xl underline md:underline-offset-8  font-bold text-gray-800">{{$Post['Title']}}</h1>
    <h3>{{$Post['date']}}</h3>
    <div>
    ...
    <a href="/about/{{$Post['slug']}}" class="font-medium text-blue-500 hover:underline">Read More &raquo</a>
    </article>
    @endforeach
