        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
             ...
             <x-item.nav href="/" :active="request() -> is('/')">Home</x-item.nav>
             <x-item.nav href="/about" :active="request() -> is('about')">about</x-item.nav>
             <x-item.nav href="/galery" :active="request() -> is('galery')">galery</x-item.nav>
             <x-item.nav href="/contact" :active="request() -> is('contact')">Contact</x-item.nav>
          </div>
        </div>
        <div class="hidden md:block">
